...
using JuMotoManager.DapperUnitOfWork;
...
namespace JuMotoManager.Services
{
    public class SupplierService : ISupplierService
    {
        ...
        {
            return _unitOfWork.SupplierRepo.Find(id);
        }      

        public List<Supplier> Get()
        {
            return _unitOfWork.SupplierRepo.All().ToList();
        }

        public void Add(Supplier b)
        {
            _unitOfWork.SupplierRepo.Add(b);
            _unitOfWork.Commit();
        }

        public void Edit(Supplier b)
        {
            _unitOfWork.SupplierRepo.Update(b);
            _unitOfWork.Commit();
        }
